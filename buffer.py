...
class RecurrentReplayBuffer:
    def __init__(self, args = default_args):
        ...
        self.observations = VariableBuffer(
            shape = (self.args.observation_shape,), 
    ...
    def push(
        ...
        self.observations.push(self.episode_ptr, self.time_ptr, observation)
        ...
        if done or self.time_ptr >= self.max_episode_len:
            self.observations.push(self.episode_ptr, self.time_ptr,  next_observation)
    ...
    def sample(self, batch_size):
        if(self.num_episodes < batch_size):
            ...
            batch = (
                self.observations.sample(indices),
